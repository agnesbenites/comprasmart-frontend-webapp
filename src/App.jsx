...
import { LojistaEscolha } from "./pages/LojistaDashboard";
...
import { LojistaProducts } from "./pages/LojistaDashboard";
console.log("✅ LojistaProducts importada:", !!LojistaProducts);

import { LojistaUsuarios } from "./pages/LojistaDashboard";
console.log("✅ LojistaUsuarios importada:", !!LojistaUsuarios);

import { LojistaVendedores } from "./pages/LojistaDashboard";
console.log("✅ LojistaVendedores importada:", !!LojistaVendedores);

import { LojistaFiliais } from "./pages/LojistaDashboard";
console.log("✅ LojistaFiliais importada:", !!LojistaFiliais);

import { LojistaQRCode } from "./pages/LojistaDashboard";
